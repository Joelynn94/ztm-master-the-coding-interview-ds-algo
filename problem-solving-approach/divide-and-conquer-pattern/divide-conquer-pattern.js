...
function refactoredSearch(array, val) {
  let min = 0;
...
console.log(refactoredSearch([1, 2, 3, 4, 5, 6], 4)); // 3
console.log(refactoredSearch([1, 2, 3, 4, 5, 6], 6)); // 5
console.log(refactoredSearch([1, 2, 3, 4, 5, 6], 11)); // -1
